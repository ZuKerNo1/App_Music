...
public class NewSongAdapter extends RecyclerView.Adapter<NewSongAdapter.MyViewHolder>{
    ...
    public NewSongAdapter(Context context, ArrayList<Song> list) {
    ...
    @NonNull
    @Override
    public NewSongAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.row_library,parent,false);
        return new NewSongAdapter.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull NewSongAdapter.MyViewHolder holder, int position) {
