...
public class POPAdapter extends RecyclerView.Adapter<POPAdapter.MyViewHolder>{
    ...
    public POPAdapter(Context context, ArrayList<Song> list) {
    ...
    @NonNull
    @Override
    public POPAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.row_library,parent,false);
        return new POPAdapter.MyViewHolder(v);
    }
